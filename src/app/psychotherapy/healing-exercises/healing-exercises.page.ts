...
@Component({
  selector: 'app-healing-exercises',
  templateUrl: './healing-exercises.page.html',
  styleUrls: ['./healing-exercises.page.scss'],
  animations: [
    trigger('colorChange', [
      state('true', style({
        opacity: 1
...
export class HealingExercisesPage implements OnInit {
