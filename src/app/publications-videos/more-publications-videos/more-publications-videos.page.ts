...
@Component({
  selector: 'app-more-publications-videos',
  templateUrl: './more-publications-videos.page.html',
  styleUrls: ['./more-publications-videos.page.scss'],
  animations: [
    trigger('colorChange', [
      state('true', style({
        opacity: 1
...
export class MorePublicationsVideosPage implements OnInit {
